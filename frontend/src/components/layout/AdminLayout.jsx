...
const sidebarLinks = [
  ...
  { to: '/admin/deals', label: 'Deals', roles: ['admin', 'manager'], icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4' },
  { to: '/admin/promotions', label: 'Promotions', roles: ['admin', 'manager'], icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  ...
  { to: '/admin/payments', label: 'Payments', roles: ['admin', 'manager'], icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
  { to: '/admin/testimonials', label: 'Testimonials', roles: ['admin', 'manager'], icon: 'M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z' },
  { to: '/admin/reviews', label: 'Reviews', roles: ['admin', 'manager'], icon: 'M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z' },
  ...
  { to: '/admin/activity-logs', label: 'Activity Logs', roles: ['admin'], icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
];
...
const AdminLayout = () => {
  ...
  const visibleLinks = sidebarLinks.filter((l) => !l.roles || (user && l.roles.includes(user.role)));
  ...
  return (
    <div className="min-h-screen bg-sand-50 dark:bg-ink-950 flex">
      ...
      <AnimatePresence mode="wait">
        {sidebarOpen && (
          <motion.aside
            ...
            className="fixed lg:static inset-y-0 left-0 z-40 w-64 bg-ink-950 overflow-y-auto"
          >
            <div className="p-4">
              <div className="flex items-center justify-between mb-8">
                ...
                <button
                  ...
                  className="lg:hidden w-8 h-8 rounded-lg text-gray-400 hover:text-white hover:bg-white/5 flex items-center justify-center transition-colors"
