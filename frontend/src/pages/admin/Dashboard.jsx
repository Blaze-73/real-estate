...
const Dashboard = () => {
  ...
  const statCards = [
    { label: 'Total Properties', value: stats?.totalProperties || 0, color: 'from-[#ececf0] to-[#c3c7cc]', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="bg-white dark:bg-ink-900 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-800">
          ...
          <div className="space-y-4">
            {[
              { label: 'Occupancy Rate', value: '78%', color: '#d9d9de' },
