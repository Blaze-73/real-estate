            ...
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }}>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <input type="text" name="name" value={form.name} onChange={handleChange} placeholder={t('propertyDetails.yourName')} className="w-full px-4 py-3 rounded-xl bg-white dark:bg-[#1E293B] border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white focus:outline-none focus:border-[#38BDF8] text-sm" required />
                  <input type="email" name="email" value={form.email} onChange={handleChange} placeholder={t('propertyDetails.yourEmail')} className="w-full px-4 py-3 rounded-xl bg-white dark:bg-[#1E293B] border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white focus:outline-none focus:border-[#38BDF8] text-sm" required />
                </div>
                <input type="tel" name="phone" value={form.phone} onChange={handleChange} placeholder={t('propertyDetails.phoneNumber')} className="w-full px-4 py-3 rounded-xl bg-white dark:bg-[#1E293B] border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white focus:outline-none focus:border-[#38BDF8] text-sm" />
                <input type="text" name="subject" value={form.subject} onChange={handleChange} placeholder={t('contact.subject')} className="w-full px-4 py-3 rounded-xl bg-white dark:bg-[#1E293B] border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white focus:outline-none focus:border-[#38BDF8] text-sm" required />
                <textarea name="message" value={form.message} onChange={handleChange} placeholder={t('propertyDetails.yourMessage')} rows={5} className="w-full px-4 py-3 rounded-xl bg-white dark:bg-[#1E293B] border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white focus:outline-none focus:border-[#38BDF8] text-sm resize-none" required />
